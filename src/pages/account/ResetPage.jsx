...
import { Collapse, Grid, Link, TextField } from '@mui/material';
                        ...
                        !nextstep && (
                            <form onSubmit={formPassword.handleSubmit}>
                                ...
                                <div>
                                    ...
                                    <div>
                                        <div style={{ marginTop: "20px", marginRight: "10px" }}>
                                            <p id="unstyled-modal-description" className="modal-description">
                                                Escribe tu correo para poder enviarte un codigo temporal para que puedas cambiar tu contrasena
                                            </p>
                                        </div>
                                        <TextField
                                            margin="normal"
                                            ...
                                            error={formPassword.touched.email && Boolean(formPassword.errors.email)}
                                            helperText={formPassword.touched.email && formPassword.errors.email}
                                            sx={CssTexField}
                                        />
                                        ...
                                        <TextField
                                            ...
                                            onChange={formPassword.handleChange}
                                            onBlur={formPassword.handleBlur}
                                            error={formPassword.touched.codigo && Boolean(formPassword.errors.codigo)}
                                            helperText={formPassword.touched.codigo && formPassword.errors.codigo}
                                            sx={CssTexField}
                                        />
                                        <div item
                                            sx={{
                                    ...
                                    <ButtonContained onClick={handleNextStep} text={"Verificar Codigo"} />
                                </div>
                                ...
                                <div>
                                    ...
                                    <div>
                                        <div style={{ marginTop: "20px", marginRight: "10px" }}>
                                            <p id="unstyled-modal-description" className="modal-description">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        Tener al menos una letra mayusucla
                                                    </li>
                                                    <li>
                                        ...
                                        <TextField
                                            ...
                                            onChange={formPassword.handleChange}
                                            onBlur={formPassword.handleBlur}
                                            error={formPassword.touched.password && Boolean(formPassword.errors.password)}
                                            helperText={formPassword.touched.password && formPassword.errors.password}
                                            sx={CssTexField}
                                        />
                                        
                                       
                                    </div>
                                    <ButtonContained onClick={handleNextStep} text={"Guardar cambios"} />
                                </div>
