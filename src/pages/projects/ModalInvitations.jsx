              ...
              >
                <Autocomplete
                  ...
                  PopperComponent={({ children, ...popperProps }) => (
                    <div>
                      <CustomPopper {...popperProps}>{children}</CustomPopper>
                      <div
                        style={{ marginBottom: popperOpen ? "40px" : "0" }}
                      />
                    </div>
                  )}
                  options={dataSelect}
                  ...
                  renderInput={(params) => (
                    <TextField {...params} label="Buscar por email" />
                  )}
                />
              </div>
              <ButtonContained
                ...
                style={{
                  height: "37px",
                  marginTop: popperOpen ? "80px" : "32px",
                }}
              />
            </div>
          </ModalContent>
